        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Thank you for applying to Doctors Welfare Trust (DWT). We have received your application and the Trustees will review your documents. Approval is at the Trustees' absolute discretion.
            </p>
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Join Doctors Welfare Trust</h1>
          <p className="text-xl text-blue-100 max-w-3xl">
            Complete the registration form below to apply for DWT membership. Open to all registered doctors aged 60 or below (Indian citizens only).
          </p>
        </div>
      </section>
            ...
            <div className="mb-8 space-y-4">
              <div className="flex items-start">
                ...
                <label htmlFor="termsAccepted" className="text-sm text-gray-700">
                  I accept the <Link to="/terms" className="text-blue-600 hover:underline">Rules &amp; Bye-Laws of DWT</Link>, understand that DWT is a voluntary mutual self-support trust (not insurance), and that all information provided is accurate and complete. *
                </label>
              </div>
