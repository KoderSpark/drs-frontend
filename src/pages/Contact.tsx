      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 max-w-3xl">
            Get in touch with Doctors Welfare Trust for any questions, support, or assistance
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 mb-8 leading-relaxed">
                Our team is here to help you with any questions about DWT membership, mutual support, contribution processes, or general inquiries. Fill out the form and we'll get back to you promptly.
              </p>
