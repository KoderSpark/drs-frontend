          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Professionals Welfare Trust (PWT) was founded with a singular vision: to create a voluntary mutual self-support system exclusively for registered doctors. Understanding the unique challenges faced by doctors across various fields, PWT brings together individuals who believe in the power of collective support.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                Today, PWT serves registered medical doctors across India — including Doctors, Dentists, Dermatologists, Surgeons, Physicians, Pediatricians, Ophthalmologists, and Orthopedic Specialists — providing them with the assurance that their medical community stands together in times of need.
              </p>
            </div>
            <div>
              <img
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-blue-100 leading-relaxed">
                  PWT is a public charitable trust — not an insurance company, not an investment scheme, and not a profit-making entity. We facilitate voluntary mutual support among doctors.
                </p>
              </div>
              <div>
