        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-10">
          ...
          <section>
            ...
            <div className="text-sm text-gray-700 space-y-3">
              <p>The Trust may operate a Mobile App, Website, Helpline, and Online communication systems. Platform use includes crisis alerts, information sharing, coordination of voluntary support, and professional networking.</p>
              <div>
